...
- **[defi-mcp](https://github.com/OzorOwn/defi-mcp)** - DeFi & crypto MCP server with 12 tools: token prices, multi-chain wallet balances, gas estimation, DEX quotes (Jupiter/Uniswap), token metadata. Supports Ethereum, Solana, Base, Arbitrum, and more.
